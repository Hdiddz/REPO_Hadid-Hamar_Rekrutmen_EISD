...
@section('title', 'Master Data | Admin KerjaLokal')
@section('portal_title', 'Master data')
@section('portal_description', 'Kelola kategori dan keterampilan yang digunakan pada lowongan. Data yang sudah terhubung tidak dapat dihapus.')
