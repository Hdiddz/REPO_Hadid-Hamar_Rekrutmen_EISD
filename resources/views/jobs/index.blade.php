...
@section('content')
    ...
    <form method="GET" action="{{ route('jobs.index') }}" class="mb-6 sm:mb-7 grid gap-3 rounded-2xl border border-slate-200 bg-white p-3.5 sm:p-4 shadow-sm sm:grid-cols-2 md:grid-cols-[1.4fr_1fr_1fr_auto] dark:border-slate-800 dark:bg-slate-900" data-reveal>
        <div class="sm:col-span-2 md:col-span-1">
            <label for="q" class="mb-1.5 block text-xs font-bold text-slate-600 dark:text-slate-300">Posisi atau lokasi</label>
            <div class="relative">
        ...
        <div class="flex items-end gap-2 sm:col-span-2 md:col-span-1">
            <button class="portal-button-primary min-h-11 flex-1 md:flex-none justify-center">
